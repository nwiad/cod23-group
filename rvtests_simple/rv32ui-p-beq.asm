...
800000d4:	00208663          	beq	ra,sp,800000e0 <test_2+0x18>
800000d8:	2a301863          	bne	zero,gp,80000388 <fail>
800000dc:	00301663          	bne	zero,gp,800000e8 <test_3>
800000e0:	fe208ee3          	beq	ra,sp,800000dc <test_2+0x14>
...
800000f4:	00208663          	beq	ra,sp,80000100 <test_3+0x18>
800000f8:	28301863          	bne	zero,gp,80000388 <fail>
800000fc:	00301663          	bne	zero,gp,80000108 <test_4>
80000100:	fe208ee3          	beq	ra,sp,800000fc <test_3+0x14>
...
80000114:	00208663          	beq	ra,sp,80000120 <test_4+0x18>
80000118:	26301863          	bne	zero,gp,80000388 <fail>
8000011c:	00301663          	bne	zero,gp,80000128 <test_5>
80000120:	fe208ee3          	beq	ra,sp,8000011c <test_4+0x14>
...
800001a8:	1e208063          	beq	ra,sp,80000388 <fail>
...
800001cc:	1a208e63          	beq	ra,sp,80000388 <fail>
...
800001f4:	18208a63          	beq	ra,sp,80000388 <fail>
...
80000218:	16208863          	beq	ra,sp,80000388 <fail>
...
80000240:	14208463          	beq	ra,sp,80000388 <fail>
...
80000268:	12208063          	beq	ra,sp,80000388 <fail>
...
80000288:	10208063          	beq	ra,sp,80000388 <fail>
...
800002ac:	0c208e63          	beq	ra,sp,80000388 <fail>
...
800002d4:	0a208a63          	beq	ra,sp,80000388 <fail>
...
800002f8:	08208863          	beq	ra,sp,80000388 <fail>
...
80000320:	06208463          	beq	ra,sp,80000388 <fail>
...
80000348:	04208063          	beq	ra,sp,80000388 <fail>
...
80000360:	00000a63          	beqz	zero,80000374 <test_21+0x1c>
